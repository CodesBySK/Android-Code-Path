...
import com.example.coffee_application.databinding.ActivitySignInBinding;
              ...
              if(email.equals("")||password.equals("")||confirmPassword.equals(""))
                  ...
                  if(password.equals(confirmPassword)){
                      ...
                      if(checkUserEmail == false){
                          ...
                          if(insert == true){
                              Toast.makeText(SignInActivity.this, "SignUp Successfully", Toast.LENGTH_SHORT).show();
                          ...
                          Toast.makeText(SignInActivity.this, "User already exist, Please login", Toast.LENGTH_SHORT).show();
                      }
                  }else {
